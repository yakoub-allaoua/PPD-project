...
const RentTAb = () => {
  ...
  return (
    <>
      <div className="bg-white/60 backdrop-blur-lg p-4 rounded-[25px] shadow-md flex flex-col md:flex-row gap-4 items-center justify-between">
        <Form
          name="basic"
          layout="vertical"
          style={{
          ...
          autoComplete="off"
          requiredMark={false}
          className="flex flex-row items-start gap-[50px] "
        >
          ...
          <div className="flex flex-col gap-[15px] items-start">
            ...
            <div className="flex flex-col gap-1 w-[220px]">
              <div className="flex justify-between text-[14px] text-textgray font-medium">
                <span>20,000 DA</span>
                <span>{sliderValue.toLocaleString()} DA</span>
              </div>
              <Slider
                min={20000}
                max={120000}
