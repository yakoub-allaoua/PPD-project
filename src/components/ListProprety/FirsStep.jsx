...
const FirstStep = () => {
  ...
  return (
    <div className="flex flex-col items-center gap-[10px] sm:gap-[20px]">
      ...
      <div className="flex flex-row gap-[40px] sm:gap-[200px] mt-[20px] sm:mt-[50px]">
        <button className="cursor-pointer" ref={rentRef}>
          <div className=" w-[80px] h-[80px] sm:w-[160px] sm:h-[160px] rounded-full flex flex-col items-center justify-center bg-greencol transition-colors hover:bg-[#6AAE78]">
            <img
        ...
        <button className="cursor-pointer" ref={buyRef}>
          <div className="w-[80px] h-[80px] sm:w-[160px] sm:h-[160px] rounded-full flex flex-col items-center justify-center bg-bggray transition-colors hover:bg-[#DADADA]">
            <img
              className="w-[30px] h-[30px] sm:w-[70px] sm:h-[70px]"
              src={buy}
            />
